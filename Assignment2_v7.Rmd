...
The comparison of model 0 and model 1 is significant ($\chi^2$(1) = 231.97, *p* < .001), which indicates that the two differ in how well they fit the data. The AIC of model 1 is 3343.5, which is lower than that of model 0, and thus indicates a better fit.
...
The comparison of model 1 and model 2 is significant ($\chi^2$(1) = 20.06, *p* < .001), which indicates that the two differ in how well they fit the data. The AIC of model 1 is 3325.5, which is lower than that of model 0, and thus indicates a better fit.
...
The comparison of model 3 and model 4 is significant ($\chi^2$(1) = 11.36, *p* < .001), which indicates that the two differ in how well they fit the data. The AIC of model 4 is 3317.8, which is lower than that of model 3, and thus indicates a better fit.
...
The comparison of model 5 and model 4 is significant ($\chi^2$(1) = 26.56, *p* < .001), which indicates that the two differ in how well they fit the data. The AIC of model 5a is 3293.3, which is lower than that of model 4, and thus indicates a better fit.
...
The comparison of model 6b and model 5a is significant ($\chi^2$(1) = 6.88, *p* = .009), which indicates that the two differ in how well they fit the data. The AIC of model 6b is 3288.4, which is lower than that of model 4, and thus indicates a better fit.
